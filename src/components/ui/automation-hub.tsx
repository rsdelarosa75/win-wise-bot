      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2 text-sm mb-6">
            ...
            <span className="text-primary font-medium">Workflow Automation</span>
          </div>
          
          <h2 className="text-4xl font-bold mb-4">
            <span className="text-primary">Automated</span> Intelligence Reports
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Set up n8n workflows to automatically generate daily betting analysis, track market movements, 
            and monitor key indicators around the clock
          </p>
        </div>
