        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 bg-secondary border border-primary/20 rounded-full px-4 py-2 text-sm">
              ...
              <span className="text-muted-foreground">Professional Sports Analytics</span>
            </div>
            ...
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
              ...
              <br />
              <span className="text-foreground">Betting Insights</span>
            </h1>
            
            <p className="text-xl text-muted-foreground max-w-lg leading-relaxed">
              Make informed betting decisions with comprehensive sports analytics, 
              real-time odds tracking, and intelligent market analysis.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6 pt-8">
            ...
            <div className="text-center space-y-2">
              ...
              <h3 className="font-semibold">Smart Advisors</h3>
