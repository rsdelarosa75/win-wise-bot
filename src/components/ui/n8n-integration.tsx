    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-gradient-to-br from-card to-card/50 border-primary/20">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-xl font-semibold">Ask Bobby 🎲</h3>
            <p className="text-sm text-muted-foreground">Enter your AI Connection URL to get Bobby's picks</p>
          </div>
        </div>

        <form onSubmit={handleTriggerWorkflow} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="webhook-url">Bobby's Engine URL</Label>
            <Input
              id="webhook-url"
              type="url"
              placeholder="https://your-instance.com/webhook/your-id"
              value={webhookUrl}
              onChange={(e) => setWebhookUrl(e.target.value)}
              className="bg-background/50"
            />
            <p className="text-xs text-muted-foreground">
              Copy this from your Bobby's Engine workflow
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Persona is hardcoded to Bobby Vegas */}
          </div>
        ...
        <Card className="p-6 bg-gradient-to-br from-card to-card/50 border-primary/20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Generated by Bobby's Engine</p>
            </div>
      ...
      <Card className="p-6 bg-gradient-to-br from-muted/20 to-muted/5 border-border/50">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            <h4 className="font-semibold">How to connect Bobby's Engine:</h4>
            <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
              ...
              <li>Return the results via the "Respond to AI Connection" node</li>
            </ol>
          </div>
        </div>
      </Card>
